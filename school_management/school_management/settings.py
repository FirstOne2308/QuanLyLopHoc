...
SECRET_KEY = 'django-insecure-7tq_@oel73%7f8+*ktg(1qo8f$*c1fur-g7fs4dqbmmf46#w7a'
...
AUTH_USER_MODEL = 'school_app.NguoiDung'

AUTHENTICATION_BACKENDS = [
    'django.contrib.auth.backends.ModelBackend',
    # 'studentManager.EmailBackEnd.EmailBackEnd'
]